...
internal static class Consolidator
{
    public static bool TryConsolidate(Situation s, object o1, object o2) // p 151
    {
        o1 = s.Walk(o1);
        o2 = s.Walk(o2);
...
*/
        ...
        if (o1 is List<object> l1 && o2 is List<object> l2)
        {
            ...
            var i = 0;
            for (; (i < l1.Count) && TryConsolidate(s, l1[i], l2[i]); ++i);
        ...
        if (type1.Name.StartsWith("ValueTuple"))
        {
            ...
            var i = 0;
            for (; (i < fields1.Length) && TryConsolidate(s, fields1[i].GetValue(o1)!, fields2[i].GetValue(o2)!); ++i);
